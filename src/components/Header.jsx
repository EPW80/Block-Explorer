    ...
    <header className="flex px-24 py-6 bg-white items-center border-b">
      ...
      <form className="w-5/12 ml-4" onSubmit={handleOnSubmit}>
        ...
        <div className="relative">
          ...
          <button
            type="submit"
            className="text-white absolute right-2.5 bottom-2.5 bg-sky-200 hover:bg-sky-300 focus:ring-4 focus:outline-none focus:ring-sky-200 font-medium rounded-lg text-sm px-4 py-2"
          >
            Search
          </button>
        </div>
